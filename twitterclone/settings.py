...
SECRET_KEY = 'pp=^_%x!(=fv=b^orhf6axo@q)s8o6@9gu8(f=ysh1-)f7yp!w'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'twitterclone', 'static')
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'twitterclone', 'appstatic')
]
